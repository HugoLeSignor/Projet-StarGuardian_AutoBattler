...
final class Version20260210000000 extends AbstractMigration
{
    ...
    {
        return 'Initial schema - all tables';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, is_searching_match TINYINT DEFAULT 0 NOT NULL, rating INT DEFAULT 1000 NOT NULL, bio VARCHAR(500) DEFAULT NULL, motto VARCHAR(100) DEFAULT NULL, profile_image VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE battle (id INT AUTO_INCREMENT NOT NULL, player1_id INT NOT NULL, player2_id INT DEFAULT NULL, duration_seconds INT DEFAULT NULL, created_at DATETIME NOT NULL, match_type VARCHAR(20) NOT NULL, bot_name VARCHAR(255) DEFAULT NULL, winner VARCHAR(50) NOT NULL, combat_logs JSON NOT NULL, team1_character_ids JSON NOT NULL, team2_character_ids JSON NOT NULL, INDEX IDX_13991734C0990423 (player1_id), INDEX IDX_13991734D22CABCD (player2_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE battle ADD CONSTRAINT FK_13991734C0990423 FOREIGN KEY (player1_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE battle ADD CONSTRAINT FK_13991734D22CABCD FOREIGN KEY (player2_id) REFERENCES user (id) ON DELETE SET NULL');

        $this->addSql('CREATE TABLE matchmaking_queue (id INT AUTO_INCREMENT NOT NULL, player_id INT NOT NULL, character_ids JSON NOT NULL, is_searching TINYINT DEFAULT 1 NOT NULL, rating INT DEFAULT 1000 NOT NULL, joined_at DATETIME NOT NULL, matched_with_id INT DEFAULT NULL, INDEX IDX_26E61B6199E6F5DF (player_id), UNIQUE INDEX UNIQ_26E61B6160144EC0 (matched_with_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE matchmaking_queue ADD CONSTRAINT FK_26E61B6199E6F5DF FOREIGN KEY (player_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE matchmaking_queue ADD CONSTRAINT FK_26E61B6160144EC0 FOREIGN KEY (matched_with_id) REFERENCES matchmaking_queue (id) ON DELETE SET NULL');
    ...
    {
        $this->addSql('ALTER TABLE matchmaking_queue DROP FOREIGN KEY FK_26E61B6160144EC0');
        $this->addSql('ALTER TABLE matchmaking_queue DROP FOREIGN KEY FK_26E61B6199E6F5DF');
        ...
        $this->addSql('DROP TABLE matchmaking_queue');
